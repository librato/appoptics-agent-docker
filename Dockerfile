...
COPY ./conf/appoptics-config-docker-stream.yaml /tmp/appoptics-configs/docker-stream.yaml
COPY ./conf/appoptics-config-task-aodocker-stream.yaml /tmp/appoptics-configs/task-aodocker-stream.yaml
